...
# b
num = int(input("User! Please enter any number : "))
my_list.append(num)
print(my_list)
...
# d
print(f'{my_list.__len__()} is our total length of the list.')

# e
my_list.pop(1)
print(f"The list after removing second item using pop() method is {my_list}.")
